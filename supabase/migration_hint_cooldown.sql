...
alter table game_config add column if not exists hint_cooldown_base int not null default 0;
alter table game_config add column if not exists hint_cooldown_per_day int not null default 0;
