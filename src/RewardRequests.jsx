...
export default function RewardRequests({onBack}){
  ...
  return <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',sans-serif"}} className="p-4 pt-10 flex justify-center">
    <div className="w-full max-w-xl">
      ...
      <p className="text-xs opacity-45 mb-4 px-1">{isRewardManager?"Every player's treat requests, in one place — from request to delivery.":"Track your requests from request to delivery, and dispute one if it's marked delivered by mistake."}</p>
